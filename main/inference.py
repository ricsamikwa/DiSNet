        ...
        for i in range(0,layers_iter):
            ...
            if p < layers-3:
                ...
                for j in range(0,len(input_index[i][0])):
                    ...
                    t_sub_cmp_proportional = (1 + (abs(split_ratio[j]-comp_rate[j])/comp_rate[j]))*t_sub_cmp*device_pace_rate 
...
def create_partition_input(split_ratio):
    partition_input = []
    ...
    for l in range(0,18):
        ...
        partition = get_partiton_info_DiSNet(l,l,split_ratio[point]) 
        ...
        for i in range(0,layers):
            if i < layers-3:
                ...
                for j in range(0,len(input_index[i][0])):
                    ...
                    t_sub_cmp_proportional = (1 + abs(1/len(comp_rate_modnn) - (comp_rate_modnn[j]/sum(comp_rate_modnn))))*t_sub_cmp*device_pace_rate
                    t_sub.append(t_sub_rec + t_sub_cmp_proportional + t_sub_send)
...
def method_opt(in_img, input_index, trans_rate,pos_max_par_partitions,comp_rate_modnn, model):
        ...
        for i in range(0,layers):
            ...
            if i < layers-3:
                ...
                for j in range(0,len(input_index[i][0])):
                    ...
                    t_sub_cmp_proportional = (1 + 0)*t_sub_cmp*device_pace_rate
